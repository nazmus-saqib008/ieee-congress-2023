...
function Hero() {
  ...
  return (
    <div id="hero" className="sm:h-[750px] h-fit text-center pt-6">
        <img
        src={bg_img}
        alt=""
      ...
      />
        <div className='h-full w-full backdrop-filter backdrop-blur-[2px] bg-opacity-30 items-center flex flex-col'>
          ...
          <h1 className='text-2xl md:text-4xl mt-28 mb-5 font-semibold uppercase text-white font-roboto'>IEEE Kolkata Section </h1>
          <h2 className='text-md md:text-xl uppercase text-white font-roboto'>presents</h2>
          <h1 className='text-4xl md:text-6xl mt-5 mb-20 font-bold uppercase subpixel-antialiased text-white [text-shadow:2px_2px_2px_var(--tw-shadow-color)] shadow-black font-roboto'> Student Congress 2023 </h1>
